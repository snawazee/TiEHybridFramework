...
import io.qameta.allure.SeverityLevel;
	...
	public class Sales_TransationPageTest {
	...
	salesTransationPage = dashboardPage.goToSalesTransactionPage();
	}
	...
	Assert.assertEquals(title, AppConstants.SALESTRANSATION_PAGE_TITLE);
